package com.y2080ad.yellowdog.services;

import com.y2080ad.yellowdog.services.routes.RoutesServer;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (serverName.equals("routesServer") || serverName.equals("routes")) {
	...
	protected static void usage() {
		...
		System.out.println(
				"     where server-name is 'routes', 'RoutesServer', " + "'accounts' or 'web' and server-port > 1024");
	}
}
